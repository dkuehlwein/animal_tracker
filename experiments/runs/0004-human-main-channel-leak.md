...
- **2026-07-07**: **NOT CLEAN — 2 real human leaks** (breaks the 07-05/07-06 two-night clean streak). 5 `identified` main-channel alerts tonight (batch 1590-1706), adjudicated:
  - **1592** (08:44, `aves;;;;;bird`, 0.886) and **1612** (11:59, `aves;;;;;bird`, 0.780) — bird taxon; frames already aged out of retention (earliest of a 116-trigger day), but `aves` rollups never carry `homo`, consistent with the daily recurring blackbird. Not leaks.
  - **1633** (14:00, `mammalia;primates;hominidae;homo;;homo species`, conf **0.994**) — **real human**. Frame unmistakable: a person in dark clothing bending over the pond edge, watering with a blue-nozzled hose in bright daylight (left third of frame). Leaked to main channel with no REVIEW prefix. **HUMAN LEAK.**
